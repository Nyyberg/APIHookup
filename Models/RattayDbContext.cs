...
public partial class RattayDbContext : DbContext
{
    public RattayDbContext()
    {
    }

    public RattayDbContext(DbContextOptions<RattayDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=RattaySQL;TrustServerCertificate=True;User=sa;Password=Varrock1611");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Kapabillitet>(entity =>
        {
            ...
            entity.HasOne(d => d.LinieNrNavigation).WithOne(p => p.Kapabillitet)
                .HasForeignKey<Kapabillitet>(d => d.LinieNr)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Kapabillitet$Linie_nrKapabillitet");
        });
        ...
        modelBuilder.Entity<TblChange>(entity =>
        {
            ...
            entity.HasOne(d => d.Reg).WithMany(p => p.TblChanges)
                .HasForeignKey(d => d.RegId)
                .HasConstraintName("tblChanges$tblTidsregtblChanges");
        });
        ...
        modelBuilder.Entity<TblChargeNr>(entity =>
        {
            ...
            entity.HasOne(d => d.Cert).WithMany(p => p.TblChargeNrs)
                ...
                .HasConstraintName("tblChargeNr$[C:\\data\\RekvTables.mdb].{777D93FE-478D-459C-BF7D-28E3B7F46216}");

            entity.HasOne(d => d.Rekv).WithMany(p => p.TblChargeNrs)
                .HasForeignKey(d => d.RekvId)
                .HasConstraintName("tblChargeNr$[C:\\data\\RekvTables.mdb].{1BCBF13D-D58A-40E3-93C7-A3D483BA2449}");
        });
        ...
        modelBuilder.Entity<TblKontaktLev>(entity =>
        {
            ...
            entity.HasOne(d => d.RekvKunde).WithMany(p => p.TblKontaktLevs)
                ...
                .HasConstraintName("tblKontaktLev$[C:\\data\\RekvTables.mdb].{85CA209C-16CF-47A0-B2E4-C6A531620AB2}");
        });
        ...
        modelBuilder.Entity<TblKontakter>(entity =>
        {
            ...
            entity.HasOne(d => d.Kunde).WithMany(p => p.TblKontakters)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("tblKontakter$[C:\\data\\ShapeTech.mdb].{9F82D9CC-795B-4B1A-9491-1490FF29458F}");
        });
        ...
        modelBuilder.Entity<TblKundeDatum>(entity =>
        {
            ...
            entity.Property(e => e.BetalingsTid).HasMaxLength(255);
            ...
            entity.Property(e => e.LeveringsTid).HasMaxLength(255);
        ...
        modelBuilder.Entity<TblMaterialer>(entity =>
        {
            ...
            entity.Property(e => e.Asme)
                .HasMaxLength(2)
                .HasColumnName("ASME");
            entity.Property(e => e.CertLink).HasMaxLength(255);
            entity.Property(e => e.ChargeId).HasColumnName("ChargeID");
            entity.Property(e => e.ChargeNr).HasMaxLength(30);
            entity.Property(e => e.ChargeNrModtaget).HasMaxLength(30);
            entity.Property(e => e.Coil).HasDefaultValue(false);
            entity.Property(e => e.Dato).HasPrecision(0);
            entity.Property(e => e.EmneId).HasColumnName("EmneID");
            entity.Property(e => e.En1020431)
                .HasMaxLength(2)
                .HasColumnName("EN10204_31");
            entity.Property(e => e.En1020432)
                .HasMaxLength(2)
                .HasColumnName("EN10204_32");
            entity.Property(e => e.FolgeLink).HasMaxLength(255);
            entity.Property(e => e.KinaLort).HasMaxLength(2);
            entity.Property(e => e.LinieId).HasColumnName("LinieID");
            entity.Property(e => e.MatrNavn).HasMaxLength(30);
            entity.Property(e => e.MatrNr).HasMaxLength(30);
            ...
            entity.Property(e => e.Placering).HasMaxLength(10);
            entity.Property(e => e.RekvId).HasColumnName("RekvID");
            entity.Property(e => e.RekvNr).HasMaxLength(20);
            entity.Property(e => e.Remarks).HasMaxLength(100);
            entity.Property(e => e.SsmaTimeStamp)
                .IsRowVersion()
                .IsConcurrencyToken()
            ...
            entity.HasOne(d => d.Linie).WithMany(p => p.TblMaterialers)
                .HasForeignKey(d => d.LinieId)
                .HasConstraintName("tblMaterialer$tbllinietblMaterialer");
        });
        ...
        modelBuilder.Entity<TblOmstempling>(entity =>
        {
            ...
            entity.Property(e => e.StpId).HasColumnName("StpID");
        ...
        modelBuilder.Entity<TblPaller>(entity =>
        {
            ...
            entity.HasOne(d => d.Rekv).WithMany(p => p.TblPallers)
                .HasForeignKey(d => d.RekvId)
                .HasConstraintName("tblPaller$[C:\\data\\RekvTables.mdb].{D94F89A8-FA09-489B-A2D6-81DACEF1CC02}");
        });
        ...
        modelBuilder.Entity<TblTilbud>(entity =>
        {
            ...
            entity.Property(e => e.HalvfabKlar).HasDefaultValue(false);
            entity.Property(e => e.KontaktId).HasColumnName("KontaktID");
            entity.Property(e => e.KundeFakturaNr).HasMaxLength(30);
            entity.Property(e => e.KundeId).HasColumnName("KundeID");
            entity.Property(e => e.LevId).HasColumnName("LevID");
            entity.Property(e => e.LevKonId).HasColumnName("LevKonID");
            ...
            entity.HasOne(d => d.Designer).WithMany(p => p.TblTilbuds)
                .HasForeignKey(d => d.DesignerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("tblTilbud$[C:\\data\\ShapeTech.mdb].{003E723E-457F-4AE6-AC21-995B798E2B86}");

            entity.HasOne(d => d.Kontakt).WithMany(p => p.TblTilbuds)
                .HasForeignKey(d => d.KontaktId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("tblTilbud$[C:\\data\\ShapeTech.mdb].{99EE63A6-EFEB-4362-B935-FAD616096333}");

            entity.HasOne(d => d.Kunde).WithMany(p => p.TblTilbuds)
                .HasForeignKey(d => d.KundeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("tblTilbud$[C:\\data\\ShapeTech.mdb].{904B5BB2-5AFB-4CC1-8DDA-B1C4E9D940A5}");
        });
        ...
        modelBuilder.Entity<Tblcertifikater>(entity =>
        {
            ...
            entity.HasOne(d => d.Rekv).WithMany(p => p.Tblcertifikaters)
                .HasForeignKey(d => d.RekvId)
                .HasConstraintName("tblcertifikater$[C:\\data\\RekvTables.mdb].{64D24697-BB55-4AFD-A1BA-4E0996CC2418}");
        });
        ...
        modelBuilder.Entity<Tblhoved>(entity =>
        {
            ...
            entity.HasOne(d => d.Kon).WithMany(p => p.Tblhoveds)
                .HasForeignKey(d => d.KonId)
                .HasConstraintName("tblhoved$[C:\\data\\RekvTables.mdb].{C2C0D9D3-4FC8-4EFC-BBAF-007E35C3D5E3}");

            entity.HasOne(d => d.RekvKunde).WithMany(p => p.Tblhoveds)
                .HasForeignKey(d => d.RekvKundeId)
                .HasConstraintName("tblhoved$[C:\\data\\RekvTables.mdb].{BCE98B96-7D59-48CD-8461-0A16BE59576A}");
        });
        ...
        modelBuilder.Entity<Tbltegninger>(entity =>
        {
            ...
            entity.HasOne(d => d.Linie).WithMany(p => p.Tbltegningers)
                .HasForeignKey(d => d.LinieId)
                .HasConstraintName("tbltegninger$[C:\\data\\RekvTables.mdb].tbllinietbltegninger");
        });
