...
public partial class Tbllinie
{
    ...
    public virtual TblChargeNr? Charge { get; set; }

    public virtual ICollection<TblMaterialer> TblMaterialers { get; set; } = new List<TblMaterialer>();

    public virtual ICollection<Tbltegninger> Tbltegningers { get; set; } = new List<Tbltegninger>();
}
